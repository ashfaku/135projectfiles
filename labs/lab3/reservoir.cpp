...
This file defines the get_east_storage function, where it takes in a date and
returns that date's east storage.
*/
...
std::string compare_basins(std::string date) {
  ...
  std::cout << "the west basin has a storage of " << west
            << " and the east basin has a storage of " << east << ". ";
